...
class ItemsController extends Controller
{
    ...
    protected function form()
    {
        ...
        $form->text('name', 'Наименование предмета')->rules('required|unique||max:255', [
            'required' => 'Обязательно для заполнения',
            'unique' => 'Должен быть уникальным',
            'max' => 'Кол-во символов не более :max',
        ]);

        $form->text('abbreviation', 'Аббревиатура')->rules('required|unique||max:10', [
            'required' => 'Обязательно для заполнения',
            'unique' => 'Должен быть уникальным',
            'max' => 'Кол-во символов не более :max',
        ]);
        $form->text('pulpit', 'Кафедра');
